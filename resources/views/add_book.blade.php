                ...
                <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="book_title" class="form-control" id="bookTitle" placeholder="Enter Book Title" required>
                        </div>

                        <!-- Book Code -->
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <label for="bookCode" class="form-label">Book Code:</label>
                            <input type="text" name="book_code" class="form-control" id="bookCode" placeholder="e.g. CHM101" required>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="publisher" class="form-control" id="publisher" placeholder="Publisher Name">
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="subject" class="form-control" id="subject" placeholder="Enter Subject or Course Code">
                        </div>

                        <!-- Rack Number -->
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <label for="rackNumber" class="form-label">Rack Number:</label>
                            <input type="text" name="rack_number" class="form-control" id="rackNumber" placeholder="Enter Rack Number">
                        </div>

                        <!-- Quantity -->
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <label for="quantity" class="form-label">Quantity:</label>
                            <input type="number" name="quantity" class="form-control" id="quantity" placeholder="Total Copies">
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <textarea class="form-control" name="description" id="description" rows="4" placeholder="Write a short summary about the book..."></textarea>
                        </div>
                    </div>
