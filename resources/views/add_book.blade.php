                ...
                <div class="card-body">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select name="author_name" class="form-select" id="author">
                                <option value="">-- Select Author (or leave blank) --</option>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select name="category_name" class="form-select" id="category" required>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="number" name="quantity" class="form-control" id="quantity" value="{{ old('quantity', 1) }}" placeholder="Total Copies" required>
                        </div>

                        <!-- Price -->
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <label for="price" class="form-label">Book Price (₹):</label>
                            <input type="number" step="0.01" name="price" class="form-control" id="price" value="{{ old('price') }}" placeholder="Enter Price">
                        </div>
