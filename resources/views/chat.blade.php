                                    ...
                                    <div class="main-content-left main-content-left-chat">
                                        <ul class="nav nav-pills nav-style-3 border-bottom px-2 pt-2" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active" data-bs-toggle="tab" role="tab" aria-current="page" href="#recent-chat" aria-selected="true">Recent Chat</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page" href="#groups" aria-selected="false" tabindex="-1">Groups</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page" href="#calls" aria-selected="false" tabindex="-1">Calls</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content main-chat-list">
                                                ...
                                                <div class="chat-users-tab" id="chat-msg-scroll">
                                                    <div class="main-chat-list">
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Socrates Itumay</span> <span class="ps-2">2 hours</span>
                                                                </div>
                                                        ...
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Dexter dela Cruz</span> <span class="ps-2">3 hours</span>
                                                                </div>
                                                        ...
                                                        <a class="media selected" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Reynante Labares</span> <span class="ps-2">10 hours</span>
                                                                </div>
                                                        ...
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Joyce Chua</span> <span class="ps-2">2 days</span>
                                                                </div>
                                                        ...
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Rolando Paloso</span> <span class="ps-2">2 days</span>
                                                                </div>
                                                                <p>Nam quam nunc, blandit vel aecenas et ante tincid</p>
                                                            </div>
                                                        </a>
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Ariana Monino</span> <span class="ps-2">3 days</span>
                                                                </div>
                                                        ...
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Maricel Villalon</span> <span class="ps-2">4 days</span>
                                                                </div>
                                                                <p>Nam quam nunc, blandit vel aecenas et ante tincid</p>
                                                            </div>
                                                        </a>
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Maryjane Pechon</span> <span class="ps-2">5 days</span>
                                                                </div>
                                                        ...
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Lovely Dela Cruz</span> <span class="ps-2">5 days</span>
                                                                </div>
                                                                <p>Mae cenas tempus, tellus eget co ndimen tum rhoncus, sem quam</p>
                                                            </div>
                                                        </a>
                                                        <a class="media new" href="#">
                                                            <div class="main-img-user"><img alt="" src="../assets/images/faces/10.jpg"></div>
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Daniel Padilla</span> <span class="ps-2">5 days</span>
                                                                </div>
                                                                <p>Mae cenas tempus, tellus eget co ndimen tum rhoncus, sem quam</p>
                                                            </div>
                                                        </a>
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>John Pratts</span> <span class="ps-2">6 days</span>
                                                                </div>
                                                                <p>Mae cenas tempus, tellus eget co ndimen tum rhoncus, sem quam</p>
                                                            </div>
                                                        </a>
                                                        <a class="media new" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Raymart Santiago</span> <span class="ps-2">6 days</span>
                                                                </div>
                                                                <p>Nam quam nunc, blandit vel aecenas et ante tincid</p>
                                                            </div>
                                                        </a>
                                                        <a class="media border-bottom-0" href="#">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-contact-name flex-wrap">
                                                                    <span>Samuel Lerin</span> <span class="ps-2">7 days</span>
                                                                </div>
                                                                <p>Nam quam nunc, blandit vel aecenas et ante tincid</p>
                                                            </div>
                                                        </a>
                                            ...
                                            <div class="tab-pane p-0 border-0" id="calls">
                                    ...
                                    <div class="main-content-body main-content-body-chat">
                                        <div class="main-chat-header pt-3">
                                            ...
                                            <div class="main-chat-msg-name ms-2">
                                                ...
                                                <span class="dot-label bg-success"></span><small class="me-3 fs-12 text-muted">Last seen: 2 minutes ago</small>
                                            </div>
                                            <nav class="nav">
                                                <a class="nav-link d-lg-none" href="javascript:void(0);" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fe fe-more-horizontal"></i>
                                                </a>
                                                ...
                                                <a class="nav-link d-lg-block d-none" data-bs-toggle="tooltip" href="javascript:void(0);" title="Phone Call"><i class="fe fe-phone-call"></i></a>
                                                <a class="nav-link d-lg-block d-none" data-bs-toggle="tooltip" href="javascript:void(0);" title="Video Call"><i class="fe fe-video"></i></a>
                                                <a class="nav-link d-lg-block d-none" data-bs-toggle="tooltip" href="javascript:void(0);" title="Add Contact"><i class="fe fe-user-plus"></i></a>
                                                <a class="nav-link d-lg-block d-none" data-bs-toggle="tooltip" href="javascript:void(0);" title="Delete"><i class="fe fe-trash-2"></i></a>
                                            </nav>
                                            ...
                                            <div class="content-inner chat-content" id="main-chat-content">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div class="pd-0">
                                                            <img alt="avatar" class="wd-100 rounded-3 mb-1 me-1" src="../assets/images/media/media-82.jpg">
                                                            <img alt="avatar" class="wd-100 rounded-3 mb-1 me-1" src="../assets/images/media/media-84.jpg">
                                                            <img alt="avatar" class="wd-100 rounded-3 mb-1" src="../assets/images/media/media-83.jpg">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="main-chat-footer">
											...
											<a class="main-msg-clip me-2" href="javascript:void(0);"><i class="fe fe-paperclip"></i></a>
                                ...
                                <div class="main-content-app d-block pt-0">
                                    <div class="chat-user-details" id="chat-user-details">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="profile.html"><h5 class=" mb-1 mt-3 fs-17">Ryan Gracie</h5></a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="media mb-3">
                                                <p class="contact-icon rounded-1 fs-17 text-primary m-0"><i class="mdi mdi-file-image"></i></p>
                                            ...
                                            <div class="media mb-3">
                                                <p class="contact-icon rounded-1 fs-17 text-danger m-0"><i class="mdi mdi-file-pdf"></i></p>
                                                <div class="media-body ms-3 d-flex">
                                                    <div class="">
                                            ...
                                            <div class="media mb-3">
                                                <p class="contact-icon rounded-1 fs-17 text-info m-0"><i class="mdi mdi-file-word"></i></p>
                                                <div class="media-body ms-3 d-flex">
                                                    <div class="">
                                            ...
                                            <div class="media">
                                                <p class="contact-icon rounded-1 fs-17 text-warning m-0"><i class="mdi mdi-file-powerpoint"></i></p>
                                                <div class="media-body ms-3 d-flex">
                                                    <div class="">
